...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  const _compareElem = document.getElementById("compare");
  const hide = _compareElem.classList.contains("hide");
  if (!hide) {
    _compareElem.classList.add("hide");
  }
...
function compare(a, b) {
  ...
  _compareElem.classList.remove("hide");
